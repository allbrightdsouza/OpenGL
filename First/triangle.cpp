...
{
	 0.5f,  0.5f, 0.0f,  0.75f,// top right
	 0.5f, -0.5f, 0.0f,  0.25f,// bottom right
...
int main()
{
	...
	unsigned int shaderProgram = shader::GetShaderProgram("vshadertest.txt", "fshadertest.txt");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform1f(glGetUniformLocation(shaderProgram, "rColor"), redValue);
		glUniform1f(glGetUniformLocation(shaderProgram, "gColor"), greenValue);
		glUniform1f(glGetUniformLocation(shaderProgram, "bColor"), 1 - greenValue);
